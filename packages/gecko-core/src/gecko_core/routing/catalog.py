...
_NAME_TO_ID: dict[str, str] = {
    ...
    "DeepSeek V4 Flash Max": "deepseek/deepseek-v4-flash-max",
...
_TASK_TIER_TO_MODEL_ID: dict[tuple[TaskProfile, Tier], str] = {
    ...
    (TaskProfile.complex_coding, Tier.free): _id("Poolside Laguna M.1"),
    ...
    (TaskProfile.simple_coding, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.planning, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.file_navigation, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.code_review, Tier.free): _id("Poolside Laguna M.1"),
    (TaskProfile.general_reasoning, Tier.quality): _id("GPT-5.5"),
    (TaskProfile.general_reasoning, Tier.balanced): _id("DeepSeek V4 Flash Max"),
    (TaskProfile.general_reasoning, Tier.budget): _id("Grok 4.1 Fast"),
    (TaskProfile.general_reasoning, Tier.free): _id("Nemotron 3 Super"),
    (TaskProfile.creative_writing, Tier.quality): _id("Claude Sonnet 4.6"),
    (TaskProfile.creative_writing, Tier.balanced): _id("Kimi K2.6"),
    (TaskProfile.creative_writing, Tier.budget): _id("Qwen3.5 Plus"),
    (TaskProfile.creative_writing, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.summarization, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.image_analysis, Tier.free): _id("Nemotron 3 Nano Omni"),
    ...
    (TaskProfile.audio_processing, Tier.free): _id("Nemotron 3 Nano Omni"),
    ...
    (TaskProfile.tool_calling, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.data_analysis, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.classification, Tier.free): _id("Nemotron 3 Super"),
    ...
    (TaskProfile.long_context, Tier.free): _id("Nemotron 3 Nano Omni"),
    ...
    (TaskProfile.math_science, Tier.free): _id("Nemotron 3 Super"),
}
